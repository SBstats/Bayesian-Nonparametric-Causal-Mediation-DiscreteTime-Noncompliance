...
######Fit parametric true model on generated data using the same Nimble code###########
#######################################################################################
...
#######################################################################################
##############Fit Parametric Nimble model on the replicated dataset####################
#######################################################################################
...
Param_model_fit <- nimbleModel(code_DG, constants_fit, data_fit, inits_fit)  # model creation

...
# Override specific coefficients for all mixture components (loop bound by K_mix_DG)
# Column names are now in format "param[c, k]" where c=component, k=covariate index
#for(cc in 1:K_mix_DG){
#  # t= 3
#  param_samples_data_generating_model[, paste0("beta_Yi[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("beta_Yi[",cc,", 5]")] <- -3
#
#  param_samples_data_generating_model[, paste0("theta_M2_t3[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_M2_t3[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_M1_t3[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("theta_M1_t3[",cc,", 5]")] <- -3
#
#  param_samples_data_generating_model[, paste0("theta_D_t3[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_D_t3[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_Z_t3[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("theta_Z_t3[",cc,", 5]")] <- -3
#
#  # t= 2
#  param_samples_data_generating_model[, paste0("theta_M2_t2[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_M2_t2[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_M1_t2[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_M1_t2[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_D_t2[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("theta_D_t2[",cc,", 5]")] <- -3
#
#  param_samples_data_generating_model[, paste0("theta_Z_t2[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("theta_Z_t2[",cc,", 5]")] <- -3
#
#  # t= 1
#  param_samples_data_generating_model[, paste0("theta_M2_t1[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_M2_t1[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_M1_t1[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_M1_t1[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_D_t1[",cc,", 4]")] <- 2.5
#  param_samples_data_generating_model[, paste0("theta_D_t1[",cc,", 5]")] <- 3
#
#  param_samples_data_generating_model[, paste0("theta_Z_t1[",cc,", 4]")] <- -2.5
#  param_samples_data_generating_model[, paste0("theta_Z_t1[",cc,", 5]")] <- -3
#}
...
sample_L0_bin_single = function(MCdensity= NULL,
  ...
  #print(pr_Bin_L0_vec_all_clusters) 
...
# check_sample_L0_bin_single = sample_L0_bin(MCdensity= NULL,
#                          BNPModels_df= posterior_samples_long,
#                          EDPM_cluster_component_number_df=check_comp_num_function,
#                          num_MC_samples=100,
#                          N=10,
#                          M=4,
#                          it=55

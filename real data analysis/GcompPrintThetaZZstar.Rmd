---
title: "G-computation: Print Theta Values (All Treatment Regimes)"
...
active_customer_theta_zzstar4 = MCInteg(var.type = input_varType1,
                                    ...
                                    num_Bin_L0 = 2,
                                    num_Cont_L0 = 0)
plot(as.numeric(active_customer_theta_zzstar4))
active_customer_theta_zzstar_CI4 = calculate_95bayesian_credible_interval(active_customer_theta_zzstar4)
active_customer_theta_zzstar_CI4


active_customer_theta_zz4 = MCInteg(var.type = input_varType1,
                                BNPModels = posterior_samples_long,
                                fixed.regime.trt = c(1,1,1),
                                ...
                                num_Bin_L0 = 2,
                                num_Cont_L0 = 0)
plot(as.numeric(active_customer_theta_zz4))
active_customer_theta_zz_CI4 = calculate_95bayesian_credible_interval(active_customer_theta_zz4)
active_customer_theta_zz_CI4


active_customer_theta_zstarzstar4 = MCInteg(var.type = input_varType1,
                                        BNPModels = posterior_samples_long,
                                        ...
                                        num_Bin_L0 = 2,
                                        num_Cont_L0 = 0)
plot(as.numeric(active_customer_theta_zstarzstar4))
active_customer_theta_zstarzstar_CI4 = calculate_95bayesian_credible_interval(active_customer_theta_zstarzstar4)
active_customer_theta_zstarzstar_CI4
...
value_attentive_theta_zzstar4 = MCInteg(var.type = input_varType1,
                                    BNPModels = posterior_samples_long,
                                    fixed.regime.trt = c(1,1,1),
                                    fixed.regime.control = rep(0,3),
                                    U1 = "c",
                                    ...
                                    num_Bin_L0 = 2,
                                    num_Cont_L0 = 0)
plot(as.numeric(value_attentive_theta_zzstar4))
value_attentive_theta_zzstar_CI4 = calculate_95bayesian_credible_interval(value_attentive_theta_zzstar4)
value_attentive_theta_zzstar_CI4


value_attentive_theta_zz4 = MCInteg(var.type = input_varType1,
                                BNPModels = posterior_samples_long,
                                fixed.regime.trt = c(1,1,1),
                                fixed.regime.control = c(1,1,1),
                                U1 = "c",
                                ...
                                num_Bin_L0 = 2,
                                num_Cont_L0 = 0)
plot(as.numeric(value_attentive_theta_zz4))
value_attentive_theta_zz_CI4 = calculate_95bayesian_credible_interval(value_attentive_theta_zz4)
value_attentive_theta_zz_CI4


value_attentive_theta_zstarzstar4 = MCInteg(var.type = input_varType1,
                                        BNPModels = posterior_samples_long,
                                        fixed.regime.trt = rep(0,3),
                                        fixed.regime.control = rep(0,3),
                                        U1 = "c",
                                        ...
                                        num_Bin_L0 = 2,
                                        num_Cont_L0 = 0)
plot(as.numeric(value_attentive_theta_zstarzstar4))
value_attentive_theta_zstarzstar_CI4 = calculate_95bayesian_credible_interval(value_attentive_theta_zstarzstar4)
value_attentive_theta_zstarzstar_CI4
...
price_attentive_theta_zzstar4 = MCInteg(var.type = input_varType1,
                                    BNPModels = posterior_samples_long,
                                    fixed.regime.trt = c(1,1,1),
                                    fixed.regime.control = rep(0,3),
                                    U1 = "d",
                                    ...
                                    num_Bin_L0 = 2,
                                    num_Cont_L0 = 0)
plot(as.numeric(price_attentive_theta_zzstar4))
price_attentive_theta_zzstar_CI4 = calculate_95bayesian_credible_interval(price_attentive_theta_zzstar4)
price_attentive_theta_zzstar_CI4


price_attentive_theta_zz4 = MCInteg(var.type = input_varType1,
                                BNPModels = posterior_samples_long,
                                fixed.regime.trt = c(1,1,1),
                                fixed.regime.control = c(1,1,1),
                                U1 = "d",
                                ...
                                num_Bin_L0 = 2,
                                num_Cont_L0 = 0)
plot(as.numeric(price_attentive_theta_zz4))
price_attentive_theta_zz_CI4 = calculate_95bayesian_credible_interval(price_attentive_theta_zz4)
price_attentive_theta_zz_CI4


price_attentive_theta_zstarzstar4 = MCInteg(var.type = input_varType1,
                                        BNPModels = posterior_samples_long,
                                        fixed.regime.trt = rep(0,3),
                                        fixed.regime.control = rep(0,3),
                                        U1 = "d",
                                        ...
                                        num_Bin_L0 = 2,
                                        num_Cont_L0 = 0)
plot(as.numeric(price_attentive_theta_zstarzstar4))
price_attentive_theta_zstarzstar_CI4 = calculate_95bayesian_credible_interval(price_attentive_theta_zstarzstar4)
price_attentive_theta_zstarzstar_CI4
...
non_active_customer_theta_zzstar4 = MCInteg(var.type = input_varType1,
                                    BNPModels = posterior_samples_long,
                                    fixed.regime.trt = c(1,1,1),
                                    fixed.regime.control = rep(0,3),
                                    U1 = "n",
                                    ...
                                    num_Bin_L0 = 2,
                                    num_Cont_L0 = 0)
plot(as.numeric(non_active_customer_theta_zzstar4))
non_active_customer_theta_zzstar_CI4 = calculate_95bayesian_credible_interval(non_active_customer_theta_zzstar4)
non_active_customer_theta_zzstar_CI4


non_active_customer_theta_zz4 = MCInteg(var.type = input_varType1,
                                BNPModels = posterior_samples_long,
                                fixed.regime.trt = c(1,1,1),
                                fixed.regime.control = c(1,1,1),
                                U1 = "n",
                                ...
                                num_Bin_L0 = 2,
                                num_Cont_L0 = 0)
plot(as.numeric(non_active_customer_theta_zz4))
non_active_customer_theta_zz_CI4 = calculate_95bayesian_credible_interval(non_active_customer_theta_zz4)
non_active_customer_theta_zz_CI4


non_active_customer_theta_zstarzstar4 = MCInteg(var.type = input_varType1,
                                        BNPModels = posterior_samples_long,
                                        fixed.regime.trt = rep(0,3),
                                        fixed.regime.control = rep(0,3),
                                        U1 = "n",
                                        ...
                                        num_Bin_L0 = 2,
                                        num_Cont_L0 = 0)
plot(as.numeric(non_active_customer_theta_zstarzstar4))
non_active_customer_theta_zstarzstar_CI4 = calculate_95bayesian_credible_interval(non_active_customer_theta_zstarzstar4)
non_active_customer_theta_zstarzstar_CI4
